...
## This repository (Vne3dgs)

### Project layout

- Library: **src/vertexnova/gs/** — Public API: **include/vertexnova/gs/** — Tests: **tests/** — Examples: **examples/**
- Learning roadmap and per-task specs: **docs/vertexnova/gs/roadmap.md**, **docs/vertexnova/gs/tasks/** — code in a PR should match the task file it implements
- Dependencies: **deps/internal/** (vnecommon, vnelogging, vnemath), **deps/external/** (e.g. googletest). No top-level `external/` or `libs/`.
