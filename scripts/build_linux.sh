...
# Autodoc:   yes
#
# This script builds Vne3dgs for Linux platforms
#==============================================================================
...
interactive_mode() {
  echo "=== Vne3dgs Interactive Build Configuration ==="
  echo ""
...
build_cmake_command() {
  ...
  if [ "$COMPILER" = "gcc" ]; then
    base_cmd="cmake -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DVNE_GS_LIB_TYPE=$LIB_TYPE -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DVNE_GS_TESTS=ON"
  elif [ "$COMPILER" = "clang" ]; then
    base_cmd="cmake -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DVNE_GS_LIB_TYPE=$LIB_TYPE -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++ -DVNE_GS_TESTS=ON"
  fi
