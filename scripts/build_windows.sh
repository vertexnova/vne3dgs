...
# Autodoc:   yes
#
# This script builds Vne3dgs for Windows with Visual Studio integration
#==============================================================================
...
build_cmake_command() {
  cmake -G "Visual Studio 17 2022" -A x64 -DCMAKE_BUILD_TYPE="$BUILD_TYPE" -DVNE_GS_LIB_TYPE="$LIB_TYPE" -DCMAKE_C_COMPILER=cl -DCMAKE_CXX_COMPILER=cl -DVNE_GS_TESTS=ON "$PROJECT_ROOT"
}
