#==============================================================================
# Vne3dgs Windows Build Script (PowerShell)
#==============================================================================
...
$ConfigureCmd = "cmake -B `"$BuildDir`" -S `"$ProjectRoot`" -DCMAKE_BUILD_TYPE=$BuildType -DVNE_GS_LIB_TYPE=$LibType -DVNE_GS_TESTS=ON $Generator"
